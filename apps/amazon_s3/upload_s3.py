...
AWS_ACCESS_KEY = "AKIA4VDBMCPWMWUNC2SM"
AWS_SECRET_KEY = "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"
    ...
    with ThreadPoolExecutor(max_threads) as executor:
        ...
        for result in results:
            ...
            if result:  # Se o upload for bem-sucedido
                ...
                relative_file_name = result.split('/')[-1].split('.')[0]  # Extraindo o nome do arquivo sem a extensão
